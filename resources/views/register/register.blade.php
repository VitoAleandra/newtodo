...
<head>
    ...
    <link id="theme-style" rel="stylesheet" href="{{asset('asset/css/reg.css')}}">
</head>

<body style="background-image: linear-gradient(45deg, #a0bb72 0%, #8BC91E 20%, #4f7212 50%);">
        ...
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                    ...
                    <form class="settings-form px-5" action="{{route('store')}}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input name="nama" type="text" class="form-control {{ $errors->has('nama') ? ' is-invalid' : '' }}" id="setting-input-1" placeholder="Masukan Nama Lengkap">
                            @if ($errors->has('nama'))
                            <span class="invalid-feedback">
                                {{ $errors->first('nama') }}
                            </span>
                        ...
                        <button type="submit" class="btn btn-primary" style="background-image: linear-gradient(45deg, #a0bb72 0%, #8BC91E 20%, #4f7212 50%);color: white">Registrasi</button>
